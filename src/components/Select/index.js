...
const Select = ({
  ...
  // Ici, la fonction onChange est appelée avec newValue comme argument. 
// Cela signifie que chaque fois que changeValue est appelée, elle met non seulement à jour 
// l'état local avec setValue(newValue) et setCollapsed(newValue), 
// mais informe également le composant parent du changement via onChange(newValue).
